        ...
        <div class="d-flex">
          <div>
            ...
            <ul class="dropdown-menu dropdown-menu-dark overflow-auto inner-y" style="height: 30vh;" aria-labelledby="dropdownMenuButton2">
              <li
                v-for="page_num in (1, 10)" :key="page_num"
              >
...
<script>
import upcomingMovie from '@/components/UpcomingMovies.vue'
...
export default {
  ...
  methods:{
    reload: function () {
      this.$store.dispatch('LoadUpcomingMovies', this.page)
    },
